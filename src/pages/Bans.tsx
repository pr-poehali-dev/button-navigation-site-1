  ...
  return (
    <div className="inner-page bans-page">
      ...
      <div className={`inner-content ${visible ? "is-visible" : ""}`}>
        ...
        <div className="page-num-tag" style={{ "--tag-color": "#B45454" } as React.CSSProperties}>02</div>
        <h2 className="inner-title" style={{ "--tag-color": "#B45454" } as React.CSSProperties}>ЗАПРЕТЫ</h2>
